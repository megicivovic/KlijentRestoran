...
public class ButtonEditorObrisiStavkuMenija extends DefaultCellEditor {
    ...
    public ButtonEditorObrisiStavkuMenija(JCheckBox checkBox, JTable tabela) {
        super(checkBox);
        button = new JButton();
        ...
        button.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {//         
                ...
                String stavkaMenija = (String) tabela.getModel().getValueAt(id, 0);

                int n = JOptionPane.showConfirmDialog(tabela, "Da li ste sigurni da želite da"
                        + " obrišete stavku menija - " + stavkaMenija + "?",
