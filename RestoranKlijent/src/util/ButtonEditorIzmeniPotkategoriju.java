...
import forme.admin.FPotkategorija;
...
public class ButtonEditorIzmeniPotkategoriju extends DefaultCellEditor {
    ...
    public ButtonEditorIzmeniPotkategoriju(JCheckBox checkBox, JTable tabela) {
        super(checkBox);
        button = new JButton();
